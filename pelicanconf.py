...
AUTHOR = u'Ananya Srivastava'
SITENAME = u'Virtual View'
SITESUBTITLE = u"A blog dedicated to computer science and open source development."
SITEURL = ''
...
# Social widget
SOCIAL = (('LinkedIn','https://www.linkedin.com/in/ananya-srivastava-9336b4220/'),
